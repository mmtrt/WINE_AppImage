...
mkdir -p ./{AppDir,appimage-builder-cache} ; cp org.winehq.wine.desktop AppDir ;
...
ln -s appimage-tool.AppDir/AppRun ./appimage-builder-cache/appimagetool && rm appimagetool-x86_64.AppImage ;
